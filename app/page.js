  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          ref={menuContentRef}
          className={`h-full flex flex-col justify-between text-right p-6 py-12 md:max-w-xl md:pl-12 md:ml-auto overflow-y-auto menu-content transition-opacity duration-[1500ms] ${
